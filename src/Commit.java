...
public class Commit implements Serializable{
    ...
    private static final String Prefix_Dir = ".gitlet/commits/";
    ...
    public void restoreFile(String fileName){
        ...
        try{
            Files.copy(backupFile.toPath(), file.toPath(), REPLACE_EXISTING, COPY_ATTRIBUTES);
        } catch (IOException e){
    ...
    /** copy file from another commit into this commit
      * and stored using the filename given. */
    public void copyFile(Commit other, String fileName, String fileNameCopy){
        ...
        try{
            Files.copy(originFile.toPath(), copyFile.toPath(), REPLACE_EXISTING, COPY_ATTRIBUTES);
        } catch (IOException e){
